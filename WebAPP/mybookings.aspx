...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="gdvbookinglist" class="table table-responsive-lg" OnRowCommand="gdvbookinglist_RowCommand" OnRowDeleting="gdvbookinglist_RowDeleting" AutoGenerateColumns="false">
        <Columns>
            <asp:TemplateField HeaderText="VehiclelId">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="BookingId">
                <ItemTemplate>
                    <asp:Label runat="server" ID="lblBId" Text='<%#Eval("BookingID") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>         
           ...
           <asp:ButtonField ButtonType="Image" ImageUrl="img/delete.png" CommandName="delete" HeaderText="Cancel Booked Vehicle" />
        </Columns>
    </asp:GridView>
</asp:Content>
