...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="gdvVehicleList" AutoGenerateColumns="false" class="table table-responsive-lg" OnRowCommand="gdvVehicleList_RowCommand" OnRowDeleting="gdvVehicleList_RowDeleting">
        <Columns>
